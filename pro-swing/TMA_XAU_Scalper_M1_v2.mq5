...
void OnTick()
{
    ...
    bool pullbackLong  = (close_price < emaSlow_curr); // cena se stáhla k/pod pomalou EMA v uptrendu
    bool pullbackShort = (close_price > emaSlow_curr); // cena nad pomalou EMA v downtrendu
